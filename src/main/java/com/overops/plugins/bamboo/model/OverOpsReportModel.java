...
public class OverOpsReportModel {
    ...
    public String toString() {
        return "OverOpsReportModel{" +
                "unstable=" + unstable +
                ", markedUnstable=" + markedUnstable +
                ", passedNewErrorGate=" + passedNewErrorGate +
                ", checkNewEvents=" + checkNewEvents +
                ", passedResurfacedErrorGate=" + passedResurfacedErrorGate +
                ", checkResurfacedEvents=" + checkResurfacedEvents +
                ", checkCriticalErrors=" + checkCriticalErrors +
                ", passedCriticalErrorGate=" + passedCriticalErrorGate +
                ", checkTotalErrors=" + checkTotalErrors +
                ", passedTotalErrorGate=" + passedTotalErrorGate +
                ", checkUniqueErrors=" + checkUniqueErrors +
                ", hasTopErrors=" + hasTopErrors +
                ", passedUniqueErrorGate=" + passedUniqueErrorGate +
                ", checkRegressedErrors=" + checkRegressedErrors +
                ", passedRegressedEvents=" + passedRegressedEvents +
                ", summary='" + summary + '\'' +
                ", newErrorSummary='" + newErrorSummary + '\'' +
                ", resurfacedErrorSummary='" + resurfacedErrorSummary + '\'' +
                ", criticalErrorSummary='" + criticalErrorSummary + '\'' +
                ", totalErrorSummary='" + totalErrorSummary + '\'' +
                ", uniqueErrorSummary='" + uniqueErrorSummary + '\'' +
                ", regressionSumarry='" + regressionSumarry + '\'' +
                ", newEvents=" + newEvents +
                ", resurfacedEvents=" + resurfacedEvents +
                ", criticalEvents=" + criticalEvents +
                ", topEvents=" + topEvents +
                ", regressedEvents=" + regressedEvents +
                '}';
    }
}
